...
exports.DocumentationMiddleware = void 0;
...
<body>
     ...
     */
    generateCategoriesHTML(doc) {
        const eventsByCategory = doc.events.reduce((acc, event) => {
        ...
        return Object.entries(eventsByCategory).map(([category, events]) => `
        <div class="category">
            <h2>${category}</h2>
            ${events.map((event) => `
                <div class="event">
